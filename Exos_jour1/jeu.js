...
function guessNumber() { //Fonction qui est appellée à chaque fois 
  readline.question('Entrez un nombre : ', (guess) => { //Methode readline.question permet de demander de rentrer une donnée dans la console
    ...
    if (isNaN(guessedNumber)) { 
      ...
      readline.close(); //On ferme le programme
    } else {
